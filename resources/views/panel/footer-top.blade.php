                    ...
                    <div class="newsletter-form">
                        <form id="newsletterForm" action="#" method="POST">
                            <div class="form-group">
                                ...
                                <button type="submit" class="newsletter-btn"><img src="{{ asset('build/assets/images/arrow-white.svg') }}" alt=""></button>
                            </div>
                        </form>
                    </div>
                    <!-- Newsletter Form end -->
            ...
            <div class="col-lg-2 col-md-4">
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="">Direct Deposit & Payments</a></li>
                    </ul>
                </div>
                <!-- Footer Links End -->
            </div>
            ...
            <!-- <div class="col-lg-12">
                <div class="footer-cta-box">
                    <div class="footer-logo">
                         <img src="{{ asset('build/assets/images/footer-logo.svg') }}" alt=""> 
...
<!-- Validator js file -->
<script src="{{ asset('build/assets/js/validator.min.js') }}"></script>
<!-- SlickNav js file -->
...
<!-- SmoothScroll -->
<script src="{{ asset('build/assets/js/SmoothScroll.js') }}"></script>
<!-- Parallax js -->
<script src="{{ asset('build/assets/js/parallaxie.js') }}"></script>
<!-- MagicCursor js file -->
<script src="{{ asset('build/assets/js/gsap.min.js') }}"></script>
<script src="{{ asset('build/assets/js/magiccursor.js') }}"></script>
<!-- Text Effect js file -->
<script src="{{ asset('build/assets/js/SplitText.js') }}"></script>
<script src="{{ asset('build/assets/js/ScrollTrigger.min.js') }}"></script>
<!-- YTPlayer js File -->
<script src="{{ asset('build/assets/js/jquery.mb.YTPlayer.min.js') }}"></script>
<!-- Wow js file -->
<script src="{{ asset('build/assets/js/wow.min.js') }}"></script>
<!-- Main Custom js file -->
<script src="{{ asset('build/assets/js/function.js') }}"></script>