            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="hero-slide">
                        ...
                        <div class="hero-slider-image">
                            <img src="{{ asset('build/assets/images/hero-bg.jpg') }}" alt="">
                        </div>
                        <!-- Slider Image End -->
                                            ...
                                            <div class="hero-introduction-video">
                                                ...
                                                <div class="video-play-button">
                                                    <a href="https://www.youtube.com/watch?v=Y-x0efG1seA" class="popup-video" data-cursor-text="Play">
                                                        <img src="{{ asset('build/assets/images/icon-play.svg') }}" alt="">
                                                    </a>
                                                    <p>introduction</p>
                                                </div>
                ...
                <div class="swiper-slide">
                    <div class="hero-slide">
                        <!-- Slider Image Start -->
                        <div class="hero-slider-image">
                            <img src="{{ asset('build/assets/images/hero-bg-2.jpg') }}" alt="">
                        </div>
                        <!-- Slider Image End -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="about-author-box wow fadeInUp" data-wow-delay="0.4s">
                                        ...
                                        <div class="about-info-box">
                                            <figure class="image-anime reveal">
                                                <img src="{{ asset('build/assets/images/author-1.jpg') }}" alt="">
                                            </figure>
                        ...
                        <div class="service-item">
                            ...
                            <div class="service-content-box">
                                ...
                                <div class="service-item-content">
                                    ...
                                    <a href="service-single.html" class="service-btn"><img src="{{ asset('build/assets/images/arrow-white.svg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <!-- Service Item End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="what-we-do-images">
                        ...
                        <div class="what-do-we-img-1">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('build/assets/images/what-we-do-img-1.jpg') }}" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="what-do-we-img-2">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('build/assets/images/what-we-do-img-2.jpg') }}  " alt="">
                            </figure>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="pricing-benefit-list wow fadeInUp" data-wow-delay="0.6s">
                        <ul>
                            <li><img src="{{ asset('build/assets/images/icon-pricing-benefit-1.svg') }}" alt="">Get 30 day free trial</li>
                            <li><img src="{{ asset('build/assets/images/icon-pricing-benefit-2.svg') }}" alt="">No any hidden fees pay</li>
                            <li><img src="{{ asset('build/assets/images/icon-pricing-benefit-3.svg') }}" alt="">You can cancel anytime </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="our-faqs-image">
                        ...
                        <div class="our-faqs-img">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('build/assets/images/faqs-img.jpg') }}" alt="">
                            </figure>
                        </div>
                        <!-- Our FAQs Img End -->
                            ...
                            <div class="client-review-images">
                                ...
                                <div class="client-image">
                                    <figure class="image-anime">
                                        <img src="{{ asset('build/assets/images/satisfy-client-img-1.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <!-- Client Image End -->
                                ...
                                <div class="client-image">
                                    <figure class="image-anime">
                                        <img src="{{ asset('build/assets/images/satisfy-client-img-2.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <!-- Client Image End -->
                                ...
                                <div class="client-image">
                                    <figure class="image-anime">
                                        <img src="{{ asset('build/assets/images/satisfy-client-img-3.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <!-- Client Image End -->
                                ...
                                <div class="client-image">
                                    <figure class="image-anime">
                                        <img src="{{ asset('build/assets/images/satisfy-client-img-4.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <!-- Client Image End -->
                                ...
                                <div class="client-image">
                                    <figure class="image-anime">
                                        <img src="{{ asset('build/assets/images/satisfy-client-img-5.jpg') }}" alt="">
                                    </figure>
                                </div>
                                <!-- Client Image End -->
                                        ...
                                        <div class="testimonial-item">
                                            ...
                                            <div class="testimonial-header">
                                                ...
                                                <div class="customer-logo">
                                                    <img src="{{ asset('build/assets/images/customer-logo.svg') }}" alt="">
                                                </div>
                                                <!-- Customer Logo End -->

                                                <!-- Testimonial Quotes Start -->
                                                <div class="testimonial-quotes">
                                                    <img src="{{ asset('build/assets/images/testimonial-quotes.svg') }}" alt="">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="testimonial-item">
                                            ...
                                            <div class="testimonial-author">
                                                ...
                                                <div class="author-image">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('build/assets/images/author-2.jpg') }}" alt="">
                                                    </figure>
                                                </div>
                                                <!-- Author Image End -->
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="testimonial-item">
                                            ...
                                            <div class="testimonial-author">
                                                ...
                                                <div class="author-image">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('build/assets/images/author-3.jpg') }}" alt="">
                                                    </figure>
                                                </div>
                                                <!-- Author Image End -->
                        ...
                        <div class="customer-rating-boxes">
                            ...
                            <div class="customer-rating-box">
                                ...
                                <div class="customer-rating-image">
                                    <img src="{{ asset('build/assets/images/icon-google.svg') }}" alt="">
                                </div>
                            ...
                            <div class="customer-rating-box">
                                ...
                                <div class="customer-rating-star-box">
                                    ...
                                    <div class="star-rating-img">
                                        <img src="{{ asset('build/assets/images/customer-rating-img.svg') }}" alt="">
                                    </div>
                                </div>
                                <!-- Customer Rating Counter End -->
                            </div>
                    ...
                    <div class="post-item wow fadeInUp">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="{{ asset('build/assets/images/post-1.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="{{ asset('build/assets/images/post-2.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html" data-cursor-text="View">
                                <figure class="image-anime">
                                <img src="{{ asset('build/assets/images/post-3.jpg') }}     " alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="{{ asset('build/assets/images/post-4.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Post Featured Image End -->
